sap.ui.define([
    ...
    function dateFormat(date){
        if(date){
            ...
            var oResourceBundle = this.getView().getModel("i18n").getResourceBundle();// get the resources
            
            var timeDay = 24 *60 * 60 * 1000;

            switch(true){
                case date.getTime() === dateNowFormat.getTime() : return oResourceBundle.getText("today");
