			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aasapui5-display": {
								"semanticObject": "aasapui5",
								"action": "display",
								"description": "sapui5 emp",
								"title": "sapui5 emp",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aa.sapui5",
									"url": sap.ui.require.toUrl("aa/sapui5")
								}
							}
						}
					}
